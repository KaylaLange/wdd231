...
function displayCredits(filteredCourses) {
    ...
    const sum = filteredCourses.reduce((accumlator, course) => accumlator + course.credits, 0);
    creditsElement.textContent = `Credits: ${sum}`;
}

function updateCoursesAndCredits(filteredCourses) {
...
document.getElementById('csebutton').addEventListener('click', () => {
    ...
    updateCoursesAndCredits(filteredCourses);
});
